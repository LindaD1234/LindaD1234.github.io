...
let stories = [
	'Human are ungrateful!',
	'They have so much but still complain',
	'My life is short and meaningless',
	'Yet I cherish it still'
];

let poetDiv = document.getElementById('poet-div');
let poetText = document.getElementById('poet-text');
...
function changeText(){
	...
	// Set the text of poet-text element depending on which section the user has currently scrolled to
	poetText.innerHTML = stories[sectionNum];
	// Map vertical scroll position to the horizontal position of the poet
	poetDiv.style.left = pos / (height * 4) * width + 'px';
